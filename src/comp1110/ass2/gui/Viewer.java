...
//    private static final int VIEWER_HEIGHT = 700;
    ...
    public static ArrayList<RoadFX> roads = new ArrayList<RoadFX>();
    public static ArrayList<SettlementFX> settlements = new ArrayList<SettlementFX>();
    public static ArrayList<KnightFX> knights = new ArrayList<KnightFX>();
    public static ArrayList<CityFX> cities = new ArrayList<CityFX>();
